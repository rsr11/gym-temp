...
const PlanCard = ()=>{
    return (
        <section className='h-[34rem]  w-[70vw] lg:w-[24vw] planCard flex justify-center hover:shadow-lg hover:shadow-white cursor-pointer hover:border-white transition-all ease-out -skew-y-6 border-2 border-gray-500' >
